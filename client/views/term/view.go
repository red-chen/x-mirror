...
import (
	...
	"github.com/red-chen/x-mirror/client/mvc"
	"github.com/red-chen/x-mirror/log"
	"github.com/red-chen/x-mirror/proto"
	"github.com/red-chen/x-mirror/util"
	"time"
)
...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "x-mirror is updating"
	case mvc.UpdateReady:
		updateMsg = "x-mirror has updated: restart x-mirror for the new version"
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://x-mirror.com"
	default:
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "x-mirror")
